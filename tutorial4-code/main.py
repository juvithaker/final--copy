...
# Import additional libraries for sound
import pygame.mixer
pygame.mixer.init()

# Load sound effects (MP3 version)
engine_sound = pygame.mixer.Sound("sounds/engine.mp3")
...
while run:
    ...
    engine_sound_played = False
    # Flag to track if engine sound has been played
    ...
    if player_car.vel != 0 and not engine_sound_played:
        play_engine_sound()
        engine_sound_played = True
